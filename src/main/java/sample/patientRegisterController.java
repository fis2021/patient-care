...
public class patientRegisterController implements Initializable {
    ...
    public void registerButtonOnAction (ActionEvent event) {
        ...
        if(fnameTextField.getText().isBlank() || lnameTextField.getText().isBlank() ||  usernameTextField.getText().isBlank() || emailTextField.getText().isBlank() || pnTextField.getText().isBlank()) {
